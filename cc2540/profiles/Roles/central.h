...
/** @defgroup GAPRole_PROFILE_PARAMETERS GAP Central Role Parameters
 * @{
 */
#define GAPRole_IRK                 0x400  //!< Identity Resolving Key. Read/Write. Size is uint8[KEYLEN]. Default is all 0, which means that the IRK will be randomly generated.
#define GAPRole_SRK                 0x401  //!< Signature Resolving Key. Read/Write. Size is uint8[KEYLEN]. Default is all 0, which means that the SRK will be randomly generated.
#define GAPRole_SIGNCOUNTER         0x402  //!< Sign Counter. Read/Write. Size is uint32. Default is 0.
#define GAPRole_BD_ADDR             0x403  //!< Device's Address. Read Only. Size is uint8[B_ADDR_LEN]. This item is read from the controller.
 ...
 */
typedef void (*pfngapRoleRssiCB_t)
(
 ...
 */
typedef uint8 (*pfngapRoleEventCB_t)
(
 ...
 * @return  void
 */
extern void GAPRole_Init( uint8 taskId );
 ...
 */
extern uint16 GAPRole_ProcessEvent( uint8 taskId, uint16 events );
