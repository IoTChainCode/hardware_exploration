...
bStatus_t SimpleProfile_AddService( uint32 services )
{
    ...
    simpleProfileChar4Config = (gattCharCfg_t *)osal_mem_alloc( sizeof(gattCharCfg_t) * linkDBNumConns );
    if (simpleProfileChar4Config==NULL)
        return ( bleMemAllocError );
    simpleProfileChar6Config = (gattCharCfg_t *)osal_mem_alloc( sizeof(gattCharCfg_t) * linkDBNumConns );//self define
    if (simpleProfileChar6Config==NULL)
        return ( bleMemAllocError );
    // Initialize Client Characteristic Configuration attributes
    GATTServApp_InitCharCfg( INVALID_CONNHANDLE, simpleProfileChar4Config );
    GATTServApp_InitCharCfg( INVALID_CONNHANDLE, simpleProfileChar6Config );//self define
...
bStatus_t SimpleProfile_SetParameter( uint8 param, uint8 len, void *value )
{
    ...
    case SIMPLEPROFILE_CHAR5:
        if ( len == SIMPLEPROFILE_CHAR5_LEN ) 
        {
            ...
            ret = bleInvalidRange;
        break;
    case SIMPLEPROFILE_CHAR6://self define
 ...
 * @return  bStatus_t
 */
bStatus_t SimpleProfile_GetParameter(uint8 param,void *value,uint8 *length)
{
    bStatus_t ret = SUCCESS;
    switch(param)
    {
    ...
    case SIMPLEPROFILE_CHAR6:
        VOID osal_memcpy( value, simpleProfileChar6, simpleProfileChar6Len );//self define
        *length=simpleProfileChar6Len;
        break;
    default:
        ret = INVALIDPARAMETER;
        *length=0;
    ...
    if ( pAttr->type.len == ATT_BT_UUID_SIZE )
    {
        ...
        case SIMPLEPROFILE_CHAR5_UUID:
            *pLen = SIMPLEPROFILE_CHAR5_LEN;
            ...
            break;
        case SIMPLEPROFILE_CHAR6_UUID://self define
            *pLen = simpleProfileChar6Len;
            VOID memcpy( pValue, pAttr->pValue, simpleProfileChar6Len );
            break;
        default:
