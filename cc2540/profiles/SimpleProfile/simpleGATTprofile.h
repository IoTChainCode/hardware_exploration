...
//self define
#define SIMPLEPROFILE_CHAR6_UUID            0xFFF6 //central/peripheral use
...
//self define
#define SIMPLEPROFILE_CHAR6_LEN          19 //central r/w and peripheral notify,should be 20
/*********************************************************************
 * TYPEDEFS
 */
 ...
 *          uint16 pointer).
 */
extern bStatus_t SimpleProfile_GetParameter(uint8 param,void *value,uint8 *length);
