...
#define GAP_ADTYPE_LE_CONFIRMATION              0x22 //!< LE Secure Connections Confirmation Value
#define GAP_ADTYPE_LE_RANDOM                    0x23 //!< LE Secure Connections Random Value
#define GAP_ADTYPE_URI                          0x24 //!< URI
#define GAP_ADTYPE_INDOOR_POSITIONING           0x25 //!< Indoor Positioning
#define GAP_ADTYPE_TRANSPORT_DATA               0x26 //!< Transport Discovery Data
#define GAP_ADTYPE_LE_FEATURES                  0x27 //!< LE Supported Features
#define GAP_ADTYPE_MAP_INDICATION               0x28 //!< Channel Map Update Indication
#define GAP_ADTYPE_PB_ADV                       0x29 //!< PB-ADV
#define GAP_ADTYPE_MESH_MESSAGE                 0x2A //!< Mesh Message
