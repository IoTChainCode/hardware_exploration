...
void math_swap(classtype &a,classtype &b) {classtype temp=a;a=b;b=temp;}//swap
template <class classtype>
classtype math_max(classtype a,classtype b) {return a>b?a:b;}//max
template <class classtype>
classtype math_min(classtype a,classtype b) {return a<b?a:b;}//min
